...
class DialogFactory(private val activity: Activity, private val paintView: PaintView) {
    ...
    fun revertConfirmationDialog(context: Context): Dialog {
        return ConfirmationDialog.Builder(context)
                ...
                .setPositiveButton(context.getString(android.R.string.yes), { paintView.clear() }, true)
    ...
    fun shareDialog(context: MainActivity): Dialog {
        return OptionsDialog.Builder(context)
                ...
                .setOption1(context.getString(R.string.label_facebook), R.drawable.ic_facebook) { context.shareToFacebook() }
                .setOption2("Messenger", R.drawable.messenger_button_blue_bg_round) { context.onShareClicked(true) }
                .setOption3("Default", R.drawable.ic_share) { context.onShareClicked(false) }
                .create()
    }
    ...
    fun supportDialog(context: Activity): Dialog {
        val mBuilder = OptionsDialog.Builder(context)
                ...
                .setOption1("Review", R.drawable.ic_support_review) {
                ...
                .setOption2("Contribute", R.drawable.ic_support_github) {
    ...
    fun saveAsConfirmationDialog(context: Context): Dialog {
        return ConfirmationDialog.Builder(context)
                ...
                .setPositiveButton(context.getString(R.string.menu_action_save), {
                    paintView.save()
                    activity.finish()
                }, true)
                .setNegativeButton(context.getString(android.R.string.copy), {
                    paintView.saveAs()
                    activity.finish()
                }, true)
                .create()
    ...
    fun exitConfirmationDialog(context: Context): Dialog {
        return ConfirmationDialog.Builder(context)
                ...
                .setPositiveButton(context.getString(android.R.string.yes), { activity.finish() }, true)
                .setIcon(R.drawable.ic_tool_eraser)
                .setNegativeButton(context.getString(R.string.menu_action_save), {
                    paintView.save()
                    activity.finish()
                }, true)
                .create()
